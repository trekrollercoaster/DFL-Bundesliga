...
class VideoMAEModel(VideoMAEPreTrainedModel, ABC):
    def __init__(self, config):
    ...
    def forward(
        ...
        >>> from src.core.VideoMAE import VideoMAEFeatureExtractor, VideoMAEModel
...
class VideoMAEForPreTraining(VideoMAEPreTrainedModel):
    ...
    def forward(
        ...
        Examples:
        ```python
        >>> from src.core.VideoMAE import VideoMAEFeatureExtractor, VideoMAEForPreTraining
        >>> import numpy as np
        >>> import torch
...
class VideoMAEForVideoClassification(VideoMAEPreTrainedModel):
    ...
    def forward(
        ...
        >>> from src.core.VideoMAE import VideoMAEFeatureExtractor, VideoMAEForVideoClassification
        >>> from huggingface_hub import hf_hub_download
